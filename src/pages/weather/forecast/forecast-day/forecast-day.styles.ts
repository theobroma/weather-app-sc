...
export const TemperatureText = Style.Grey500.MarginTop(20).SpanStyled`
    font-size: 24px;`;
...
export const ForecastDayWrapper = Style.Flex.Column.Grey50Bg.CrossAxisCenter.Radius(4).Padding(36).DivStyled`
